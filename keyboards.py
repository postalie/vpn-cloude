...
async def get_subscription_menu_kb(short_link=None):
    ...
    btns.append([InlineKeyboardButton(text="⚙️ Управление устройствами", web_app=WebAppInfo(url="https://158.160.201.209/dashboard?tab=devices"))])
...
def get_device_action_kb():
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="➕ Добавить устройство", web_app=WebAppInfo(url="https://158.160.201.209/dashboard?tab=add"))],
            [InlineKeyboardButton(text="⚙️ Управление устройствами", web_app=WebAppInfo(url="https://158.160.201.209/dashboard?tab=devices"))],
